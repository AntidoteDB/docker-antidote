...
main(_Args) ->
    ...
    {ok, Desc3} = getDesc(antidote@dc3n1),
    io:format("~n===============~nDescriptor DC3: ~p ~n===========~n", [Desc3]),

    Response = rpc:call('antidote@dc1n1', antidote_dc_manager, subscribe_updates_from, [[Desc2, Desc3]], 25000),
    io:format("~n===============~nResponse from DC1: ~p ~n===========~n", [Response]),

    Response2 = rpc:call('antidote@dc2n1', antidote_dc_manager, subscribe_updates_from, [[Desc1, Desc3]], 25000),
    io:format("~n===============~nResponse from DC2: ~p ~n===========~n", [Response2]),

    Response3 = rpc:call('antidote@dc3n1', antidote_dc_manager, subscribe_updates_from, [[Desc1, Desc2]], 25000),
    io:format("~n===============~nResponse from DC3: ~p ~n===========~n", [Response3]).
